  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=${debouncing}&units=metric&appid=55140bef13c48664c68c05e193f57bf5`,
      );
    ...
    <div className="weather-container">
      <div className="weather-card">
        ...
        <div className="result-display">
          {loading && <p>Loading...</p>}
          {error && (
            <p style={{ color: "#fb0606d3", fontWeight: 700 }}>{error}</p>
          )}
